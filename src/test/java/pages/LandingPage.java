...
public class LandingPage {
    ...
    private UICollection suggestedCollection = EEx("//*[@resource-id='android:id/tabs']//*[@text='Suggested']");
    private UIElement map = E(byXpath("//*[@resource-id='android:id/tabs']//*[@text='Map']"));
    private UIElement fakeElement = E(byXpath("//*[@resource-id='android:id/tabs']//*[@text='XXXXX']"));
